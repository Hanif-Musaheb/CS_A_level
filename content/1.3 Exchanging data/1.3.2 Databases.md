...
Pros|Easy to use, Easy to setup, Inexpensive, suitable for single file database, all records are in one place| Reduced data redundency and more consistency
Cons|Data redundancy, Low security, No levels of authority, Takes more memory|Very time consuming
